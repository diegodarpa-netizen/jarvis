...
| **Trading/Finanzas** | Portfolio de CEDEARs, briefing de mercado, scanner de oportunidades, XAU/USD scalping, BTC scalping | `jarvis/scripts/` (finanzas personales) + `jarvis/trading/` (XAU/USD) + `jarvis/btc_scalping/` |
